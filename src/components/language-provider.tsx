...
const translations = {
  tr: {
    ...
    templateSectionTitleRequired: "Bir bölüm eklendiyse bölüm başlığı zorunludur.",
    templateSourceNameRequired: "Bir kaynak eklendiyse kaynak adı zorunludur.",
    templateSourceUrlRequired: "Bir kaynak eklendiyse URL zorunludur.",
    templateSourceUrlInvalid: "Kaynak URL'si geçerli bir adres olmalıdır.",
    ...
    createFirstTemplate: "İlk rapor şablonunu oluştur",
    createFirstTemplatePrompt: "Henüz şablon yok. İlk şablonu oluşturabilir veya şablonsuz özel rapor başlatabilirsiniz.",
    legacyReportLabel: "Eski rapor / Şablon atanmamış",
    legacyReportHelp: "Bu rapor mevcut bölüm kayıtlarıyla çalışır; bir şablona bağlı değildir.",
  ...
  en: {
    ...
    templateSectionTitleRequired: "Section title is required when a section row exists.",
    templateSourceNameRequired: "Source name is required when a source row exists.",
    templateSourceUrlRequired: "Source URL is required when a source row exists.",
    templateSourceUrlInvalid: "Source URL must be a valid URL.",
    ...
    createFirstTemplate: "Create your first report template",
    ...
    legacyReportLabel: "Legacy report / No template assigned",
    legacyReportHelp: "This report uses its existing section records and is not dependent on a template.",
