...
const translations = {
  tr: {
    ...
    officialUrls: "Resmî kaynak adresleri (her satıra bir adres)",
    ...
    nextUrls: "Resmî internet adresleri alınır ve indekslenir.",
  ...
  en: {
    ...
    sourcesContext: "Sources and context", officialUrls: "Official source URLs (one per line)",
    ...
    nextTemplate: "A 10-section professional template is created.", nextUrls: "Official URLs are fetched and indexed.",
